...
#define clk_enable_I2C1()    (RCC->APB1ENR |= 1<<21)
#define clk_enable_I2C2()    (RCC->APB1ENR |= 1<<22)
//-*-*-*-*-*-*-*-*-*-*-*-
...
#define clk_disable_I2C1()    (RCC->APB1RSTR |= 1<<21)
#define clk_disable_I2C2()    (RCC->APB1RSTR |= 1<<22)
//Generic Macros:
//-*-*-*-*-*-*-*-*-*-*-*
//IVT
//-*-*-*-*-*-*-*-*-*-*-*
...
#define NVIC_I2C1_EV_IRQ_ENABLE		(NVIC_ISER0 |= 1<<31)
#define NVIC_I2C1_ER_IRQ_ENABLE		(NVIC_ISER1 |= 1<<0)
#define NVIC_I2C2_EV_IRQ_ENABLE		(NVIC_ISER1 |= 1<<1)
#define NVIC_I2C2_ER_IRQ_ENABLE		(NVIC_ISER1 |= 1<<2)

#define NVIC_I2C1_EV_IRQ_DISABLE 	(NVIC_ICER0 |= 1<<31)
#define NVIC_I2C1_ER_IRQ_DISABLE 	(NVIC_ICER1 |= 1<<0)
#define NVIC_I2C2_EV_IRQ_DISABLE 	(NVIC_ICER1 |= 1<<1)
#define NVIC_I2C2_ER_IRQ_DISABLE 	(NVIC_ICER1 |= 1<<2)
