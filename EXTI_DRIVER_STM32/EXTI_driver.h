...
#ifndef INCLUDE_EXTI_DRIVER_H_
#define INCLUDE_EXTI_DRIVER_H_
...
typedef struct
{
	EXTI_GPIO_MAPPING_t EXTI_PIN;		//Specifies the external interrupt GPIO mapping.
										//The parameters are defined @ref EXTI_define
	uint8_t 			Trigger_case;	//Specifies Rising, falling or both.
										//The parameters are defined @ref EXTI_Trigger define
	uint8_t				IRQ_EN;			//Enable or disable the EXTI mask
										//The parameters are defined @ref IRQ_en
	void(*P_IRQ_Call_Back)(void);		//set the c function to be called when EXTI happens
}EXTI_PinConfig_t;
//-----------------------------
...
//@ref EXTI_Trigger define
#define EXT_Trigger_Rising				0
#define EXT_Trigger_Falling				1
#define EXT_Trigger_RisingAndFalling	2
